...
import 'package:cargo_app/fetches/getImage.dart';
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () async {
                        String buffer =
                            await ImageString.imageToBase64(imageFile[0]);
                        showModalBottomSheet(
                            context: context,
                            builder: (context) {
                              var like = false;
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        bool ans2 = await AuthClient()
                            .postProductPhotoAddStatic(imageFile[0],
                                widget.latLng, select, description.text);
                        String buffer =
                            await ImageString.imageToBase64(imageFile[0]);
                        print('1234');
                        print(ImageString.images.last == buffer);
                        showModalBottomSheet(
                            context: context,
                            builder: (context) {
                              var like = false;
